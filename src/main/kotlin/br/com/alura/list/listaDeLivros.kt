...
fun listaDeLivros() {
    ...
    //lista permite que use o método add que adiciona um novo elemento a lista
    //não é necessário pré-definir o tamanho como nos arrays
    livros.add(
        Livro(
            titulo = "Sagarana",
            autor = "João Guimarães Rosa",
    ...
    val titulos: List<String> = listaDeLivros2
